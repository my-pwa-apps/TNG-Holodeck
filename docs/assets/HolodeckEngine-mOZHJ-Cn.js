...
`].filter(Ss).join(`
`)),o=wa(o),o=Ec(o,t),o=Tc(o,t),a=wa(a),a=Ec(a,t),a=Tc(a,t),o=bc(o),a=bc(a),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const x=E+m+o,v=E+p+a,C=yc(i,i.VERTEX_SHADER,x),w=yc(i,i.FRAGMENT_SHADER,v);i.attachShader(_,C),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function L(P){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(C).trim(),H=i.getShaderInfoLog(w).trim();let K=!0,V=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(K=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,C,w);else{const ne=Sc(i,C,"vertex"),G=Sc(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
